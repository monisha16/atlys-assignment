...
const AtlysModal = (props) => {
  const { children, setShowAuthModal } = props;
  ...
  return (
    <div className='fixed inset-0 bg-charcoal-dark bg-opacity-25 backdrop-blur-sm flex items-center justify-center duration-500'>
